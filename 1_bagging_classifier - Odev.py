...
bagging_model = BaggingClassifier(
     ...
     n_estimators=2, # kullanilacak model sayisi
     max_samples=0.5, # her modeiln kullanacagi ornek orani
     max_features=0.2, # her modelin kullanacagi ozellik orani
     bootstrap=False, # orneklerin tekrar secilip secilmesine izin ver
